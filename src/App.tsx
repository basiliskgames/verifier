    ...
    <BrowserRouter basename="/verify">
      ...
      <div className='page'>
        <Switch>
          ...
          <Route path="/miami" exact><Pages.Mafia game="miami"/></Route>
          <Route path="/carnival_fiesta" exact><Pages.Mafia game="carnival_fiesta"/></Route>
          <Route path="/puppy_paradise" exact><Pages.Mafia game="puppy_paradise"/></Route>
